...
__all__ = ["apply_torch_compat_patches", "prepare_process_environment", "__version__"]

__version__ = "0.2.0"

logger = logging.getLogger("voxcpm2_compat")
...
def apply_torch_compat_patches() -> None:
    ...
    logger.info("applied VoxCPM2 compatibility patches")
